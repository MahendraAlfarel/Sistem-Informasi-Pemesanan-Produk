                    ...
                    <div class="table-responsive">
                        <table id="add-row" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                <?php
                                $i = 1;
                                $ambil = $con->query("SELECT * FROM tb_invoice JOIN tb_pesanan ON tb_invoice.id_pesanan = tb_pesanan.id_pesanan JOIN tb_pelanggan ON tb_pesanan.id_pelanggan = tb_pelanggan.id_pelanggan WHERE status_pesanan = 'Menunggu Konfirmasi' ORDER BY tb_pesanan.id_pesanan ASC");
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <div class="btn-group dropdown">
                                                <button class="btn btn-info btn-sm btn-round dropdown-toggle" type="button" data-bs-toggle="dropdown">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>
                                                        <form method="POST" action="">
                                                            ...
                                                            <input type="hidden" name="status_pesanan" value="Sedang Diproses">
                                                            <button type="submit" name="update" class="dropdown-item">Sedang Diproses</button>
                                                        </form>
                                                    </li>
                                                    <li>
                                                        <form method="POST" action="">
