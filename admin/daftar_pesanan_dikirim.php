...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Daftar Pesanan Sedang Dikirim</h3>
            <ul class="breadcrumbs mb-3">
                <li class="nav-home"><a href="index.php"><i class="icon-home"></i></a></li>
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="index.php?halaman=daftarkategori">Daftar Pesanan Sedang Dikirim</a></li>
            </ul>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Data Pesanan Sedang Dikirim</h4>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table id="add-row" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                <?php
                                $i = 1;
                                $ambil = $con->query("SELECT * FROM tb_invoice JOIN tb_pesanan ON tb_invoice.id_pesanan = tb_pesanan.id_pesanan JOIN tb_pelanggan ON tb_pesanan.id_pelanggan = tb_pelanggan.id_pelanggan  WHERE status_pesanan = 'Sedang Dikirim' ORDER BY tb_pesanan.id_pesanan ASC");
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <div class="btn-group dropdown">
                                                <button class="btn btn-primary btn-sm btn-round dropdown-toggle" type="button" data-bs-toggle="dropdown">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>
                                                        <form method="POST" action="">
                                                            ...
                                                            <button type="submit" name="update" class="dropdown-item">Selesai</button>
                                                        </form>
                                                    </li>
                                                    <li>
                                                        <form method="POST" action="">
                                            ...
                                            <?php elseif ($_SESSION['level'] === 'manajer'): ?>
                                                <div class="btn-group">
                                                    <button class="btn btn-primary btn-sm btn-round" type="button">
                                                        <?= htmlspecialchars($pesanan['status_pesanan']); ?>
                                                    </button>
                                                </div>
                                            <?php endif; ?>
